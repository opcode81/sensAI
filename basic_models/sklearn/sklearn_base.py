...
class AbstractSkLearnVectorRegressionModel(VectorRegressionModel, ABC):
    ...
    def __init__(self, modelConstructor, modelInputTransformer=None, modelOutputTransformer=None,
            inputTransformers: List[DataFrameTransformer] = (), outputTransformers: List[DataFrameTransformer] = (),
            trainingOutputTransformers: List[DataFrameTransformer] = (), **modelArgs):
        """
...
class AbstractSkLearnVectorClassificationModel(VectorClassificationModel, ABC):
    def __init__(self, modelConstructor, inputTransformers: List[DataFrameTransformer] = (), **modelArgs):
        """
