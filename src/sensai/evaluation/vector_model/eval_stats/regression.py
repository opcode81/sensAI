...
class RegressionEvalStats(VectorModelEvalStats["RegressionMetric"]):
    ...
    def plotScatterGroundTruthPredictions(self, figure=True, titleAdd=None, **kwargs):
        """
        :param figure: whether to plot in a separate figure
        :param titleAdd: addition to default title of the figure
...
class RegressionEvalStatsCollection(VectorModelEvalStatsCollection[RegressionEvalStats]):
...
# TODO or not TODO: the amount of generic types make it quite hard to read. Maybe we can reduce the complexity somehow?
